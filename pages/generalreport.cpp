...
void GeneralReport::setTable()
{
    ...
    case Report::Cars:
        ...
        for (const QVariant &driver : ReportOperations::getCarsReportByDays(this->fromDate, this->toDate))
        {
            ...
            row.append(new QStandardItem(drivers[2].toString()));  // Inves
            ...
            row.append(new QStandardItem(QString::number(drivers[6].toDouble())));  // KWh
            ...
            row.append(new QStandardItem(QString::number(drivers[9].toInt())));  // Day
            row.append(new QStandardItem(QString::number(drivers[10].toInt())));  // Non-Z
            row.append(new QStandardItem(QString::number(drivers[11].toInt())));  // Avg Pr
            row.append(new QStandardItem(QString::number(drivers[12].toInt())));  // Pe
            row.append(new QStandardItem(QString::number(drivers[13].toInt())));  // Ou
            row.append(new QStandardItem(QString::number(drivers[14].toInt())));  // Investo
