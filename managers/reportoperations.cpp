...
QVariantList ReportOperations::getChargesDriverReport(QDate fromDate, QDate toDate)
{
    toDate = toDate.addDays(1);
    QVariantList result;
    dbManager &db = dbManager::getInstance();
    QString query =
        ...
        "WHERE charges.date BETWEEN '" + fromDate.toString("yyyy-MM-dd") +
...
QVariantList ReportOperations::getAllChargesDriverReport(QDate fromDate, QDate toDate)
{
    toDate = toDate.addDays(1);
    QVariantList result;
    dbManager &db = dbManager::getInstance();
...
QVariantList ReportOperations::getAllChargesByDriverReport(int id, QDate fromDate, QDate toDate)
{
    toDate = toDate.addDays(1);
    QVariantList result;
    dbManager &db = dbManager::getInstance();
