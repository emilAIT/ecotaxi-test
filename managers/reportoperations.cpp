...
/////////////////////////////////////////////////////////////
/// \brief ReportOperations::getDriversChargesReport
/// \param fromDate
/// \param toDate
/// \return
///
...
QVariantList ReportOperations::getAllChargesByDriversReport(int id, QDate fromDate, QDate toDate)
{
    toDate = toDate.addDays(1);
    QVariantList result;
    dbManager &db = dbManager::getInstance();
...
QVariantList ReportOperations::getDriversChargesByDriversReport(int id, QDate fromDate, QDate toDate)
{
    toDate = toDate.addDays(1);
    QVariantList result;
    dbManager &db = dbManager::getInstance();
