...
void PDFmanager::pdfmanagerbydays(QString title, QString dates, QList<QAbstractItemModel *> models)
{
    ...
    htmlParts << "<h1>" + title + "</h1>";
    htmlParts << "<p>Период: " + dates + "</p>";
    ...
    while (startDate <= endDate) {
        ...
        htmlParts << createDailyReportPage(startDate, modelIndex >= 0 ? models[modelIndex] : nullptr);
    ...
    createPDF(htmlParts.join(""), finalTitle);
